...
def store_danna_logs(log_dir, log_file, log_folder_flows, num_paths, file_name, per_flow_log_file_name, danna_output):
...
def compute_danna(feasibility_grb_method, mcf_grb_method, link_cap, U, problem, paths):
        ...
        for topo_name in TOPO_NAME_LIST:
            for tm_model in TM_MODEL_LIST:
                ...
                for file_name in fnames:
                    ...
                    danna_output = compute_danna(feasibility_grb_method, mcf_grb_method, link_cap, U, problem, paths)

                    store_danna_logs(log_dir, log_file, log_folder_flows, num_paths, file_name, per_flow_log_file_name,
                                     danna_output)

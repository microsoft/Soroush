...
TM_MODEL_LIST = ['uniform', 'poisson-high-inter']
    ...
    for topo_name in TOPO_NAME_LIST:
        for tm_model in TM_MODEL_LIST:
            ...
            for file_name in fnames:
                ...
                danna_fid_to_total_rate, danna_dur = danna_practical_max_min_fair.get_rates(U, problem, paths, link_cap, break_down=False)
